describe Euston::EventStore do
  ...
  describe 'optimistic event stream' do
    ...
    context 'when committing a commit that was generated by an event subscription rather than a command' do
      let(:commit_id) { uuid.generate }
      let(:headers) { { event_subscription: { a: :b }, id: uuid.generate } }
      let(:uncommitted) { Euston::EventStore::EventMessage.new 'headers' => headers, 'body' => {} }
